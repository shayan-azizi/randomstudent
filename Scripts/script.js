let myList = ["امیرپارسا احمدلو", "آروین احمدی", "محمد ایلیا افلاکی", "پارسا اقدامی", "بردیا امیریان", "شایان آزادی", "محمدصدرا برهانی", "محمدرضا تبرکی",
...
function felan () {
    ...
    let randomStudent = myList[randomNumber];
